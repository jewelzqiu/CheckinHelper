...
public class Tag extends WeiboResponse implements java.io.Serializable {
	...
	public Tag(Response res, Element elem, Weibo weibo, String str)
	...
	public static List<Tag> constructTags(Response res, Weibo weibo)
			throws WeiboException {
	...
	public static List<Tag> createTags(Response res, Weibo weibo)
			throws WeiboException {
		Document doc = res.asDocument();
		if (isRootNodeNilClasses(doc)) {
			return new ArrayList<Tag>(0);
	...
	public static List<Tag> destroyTags(Response res, Weibo weibo)
			throws WeiboException {
		Document doc = res.asDocument();
		if (isRootNodeNilClasses(doc)) {
			return new ArrayList<Tag>(0);
